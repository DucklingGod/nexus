    ...
    <div className="absolute inset-y-0 left-0 z-40 flex w-72 flex-col border-r border-nexus-border bg-nexus-elevated shadow-2xl">
      ...
      <div className="px-3 py-2">
        <input
          ...
          className="w-full rounded-xl border border-nexus-border bg-nexus-surface px-3 py-1.5 text-xs text-nexus-fg placeholder-nexus-muted outline-none focus:border-nexus-accent"
        />
      </div>
      ...
      <div className="px-3 pb-2">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-xl border border-dashed border-nexus-border px-3 py-2 text-xs text-nexus-muted transition hover:border-nexus-accent hover:text-nexus-accent"
        >
          <span>+</span> New Chat
        </button>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-2">
        ...
        {conversations.map(conv => (
          <button
            ...
            className={`group flex w-full flex-col gap-1 rounded-xl px-3 py-2.5 text-left transition hover:bg-nexus-surface ${
