    ...
    <div className="flex flex-col gap-8 p-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <a
          ...
          className="flex items-center gap-3 rounded-xl border border-nexus-border bg-nexus-surface px-4 py-3 text-sm text-nexus-fg hover:border-nexus-accent hover:text-nexus-accent transition"
        >
      ...
      {/* License */}
      <div className="rounded-xl border border-nexus-border bg-nexus-surface px-4 py-3 text-center">
      ...
      <div className="rounded-xl border border-red-900/40 bg-red-950/10 p-5">
        ...
        {!confirming ? (
          <button onClick={() => setConfirming(true)} disabled={resetting}
            className="mt-3 rounded-xl border border-red-900/50 px-4 py-2 text-xs font-medium text-red-300 transition hover:bg-red-950/40 disabled:opacity-50">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <button onClick={() => setConfirming(false)} disabled={resetting}
              className="rounded-xl border border-nexus-border px-3 py-1.5 text-xs text-nexus-muted hover:bg-nexus-surface disabled:opacity-50">Cancel</button>
            <button onClick={handleReset} disabled={resetting}
              className="rounded-xl bg-red-600/90 px-4 py-1.5 text-xs font-medium text-white transition hover:bg-red-600 disabled:opacity-50">
